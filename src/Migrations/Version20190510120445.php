 ...
 */
final class Version20190510120445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FD07ECCB6 FOREIGN KEY (advert_id) REFERENCES advertising (id)');
    }
